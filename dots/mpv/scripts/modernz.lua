...
layouts["modern"] = function()
	...
	if playlist_button then
		...
		lo.geometry = {
			x = 127 - (audio_track and 0 or 45) - (subtitle_track and 0 or 45),
			y = refY - 35,
			an = 5,
			w = 24,
			h = 24,
	...
	if audio_track then
		...
		lo.geometry = {
			x = 172 - (audio_track and 0 or 45) - (subtitle_track and 0 or 45) - (playlist_button and 0 or 45),
			y = refY - 35,
			an = 5,
			w = 24,
			h = 24,
		...
		lo.geometry = {
			x = 200 - (audio_track and 0 or 45) - (subtitle_track and 0 or 45) - (playlist_button and 0 or 45),
			y = refY - 35,
			an = 4,
			w = 55,
			h = 4,
	...
	if user_opts.cache_info then
		local cache_x_offset = (download_button and 0 or 45)
			+ (speed_button and 0 or 45)
			+ (loop_button and 0 or 45)
			+ (screenshot_button and 0 or 45)
			+ (ontop_button and 0 or 45)
		...
		lo.geometry = {
			x = osc_geo.w - 345 + cache_x_offset,
			y = refY - 35,
			an = 6,
...
local function osc_init()
	...
	ne.visible = (
		osc_param.playresx
		>= 850 - outeroffset - (user_opts.info_button and 0 or 100) - (user_opts.fullscreen_button and 0 or 100)
	)
	ne.eventresponder["mbtn_left_up"] = function()
	...
	ne.visible = (
		...
		>= 1250
			- outeroffset
			- (user_opts.speed_button and 0 or 100)
			- (user_opts.loop_button and 0 or 100)
			- (user_opts.screenshot_button and 0 or 100)
			- (user_opts.ontop_button and 0 or 100)
			- (user_opts.info_button and 0 or 100)
